...
const ShopBreadCrumb1: React.FC<Props> = ({ data, productPerPage, dataType }) => {
    ...
    return (
        <>
            ...
            <div className="shop-product breadcrumg1 md:py-20 py-10">
                <div className="container">
                    <div className="flex">
                        <div className="sidebar w-1/4 pr-12">
                            <div className="filter-type pb-8 border-b border-line">
                                <div className="heading6">Products Type</div>
                                <div className="list-type mt-4">
                                    {['t-shirt', 'dress', 'top', 'swimwear', 'shirt', 'underwear'].map((item, index) => (
                                        <div
                                            key={index}
                        ...
                        <div className="list-product-block w-3/4 pl-3">
                            <div className="filter-heading flex items-center justify-between gap-5 flex-wrap">
                                <div className="left flex has-line items-center flex-wrap gap-5">
                                    <div className="choose-layout flex items-center gap-2">
                                        ...
                                        <div className="item row p-2 border border-line rounded flex items-center justify-center cursor-pointer">
                            ...
                            <div className="list-product hide-product-sold grid sm:grid-cols-3 grid-cols-2 sm:gap-[30px] gap-[20px] mt-7">
