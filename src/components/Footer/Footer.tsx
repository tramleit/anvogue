                            ...
                            <div className="right-content flex flex-wrap gap-y-8 basis-3/4 max-lg:basis-full">
                                <div className="list-nav flex justify-between basis-2/3 max-md:basis-full gap-4">
                                    <div className="item flex flex-col basis-1/3 ">
                                        ...
                                        <Link className='caption1 hover:text-green duration-300 w-fit pt-2' href={'/career'}>Career</Link>
                                        <Link className='caption1 hover:text-green duration-300 w-fit pt-2' href={'/my-account'}>My Account</Link>
                                        <Link className='caption1 hover:text-green duration-300 w-fit pt-2' href={'/order-returns'}>Order  & Returns</Link>
                                        <Link className='caption1 hover:text-green duration-300 w-fit pt-2' href={'/faqs'}>FAQs</Link>
                                    </div>
                                    <div className="item flex flex-col basis-1/3 ">
                                        <div className="text-button-uppercase pb-3">Quick Shop</div>
                                        <Link className='caption1 hover:text-green duration-300 w-fit' href={'#!'}>Women</Link>
                                        <Link className='caption1 hover:text-green duration-300 w-fit pt-2' href={'#!'}>Men</Link>
                                        <Link className='caption1 hover:text-green duration-300 w-fit pt-2' href={'#!'}>Clothes</Link>
                                        <Link className='caption1 hover:text-green duration-300 w-fit pt-2' href={'#!'}>Accessories</Link>
                                        <Link className='caption1 hover:text-green duration-300 w-fit pt-2' href={'/blog'}>Blog</Link>
                                    </div>
                                    <div className="item flex flex-col basis-1/3 ">
                                        <div className="text-button-uppercase pb-3">Customer Services</div>
                                        <Link className='caption1 hover:text-green duration-300 w-fit' href={'#!'}>Orders FAQs</Link>
                                        <Link className='caption1 hover:text-green duration-300 w-fit pt-2' href={'#!'}>Shipping</Link>
                                        <Link className='caption1 hover:text-green duration-300 w-fit pt-2' href={'#!'}>Privacy Policy</Link>
